...
/* Administration page */
function AdminsCRUD({ onLogin, userAdmin }) {
    ...
    const handleRemoveAdminClick = (admin) => {
        if (admin.id === 0 || userAdmin.id === admin.id) {
            setMessageAlert("Cannot remove main admin or yourself.");
        } else {
    ...
    const handleCreateAdminSubmit = async (admins) => {
    ...
    const handleEditAdminSubmit = async (admins) => {
            ...
            {showCreateOverlay && (
                <div className="overlay">
                    <div className="overlay-content">
                        ...
                        <div className="button-group">
                            <button onClick={() => handleCreateAdminSubmit(admins)}>Create</button>
            ...
            {showEditOverlay && (
                <div className="overlay">
                    <div className="overlay-content">
                        ...
                        <div className="button-group">
                            <button onClick={() => handleEditAdminSubmit(admins)}>Save</button>
